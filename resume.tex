...
% CONTACT INFORMATION
%====================
\def\name{Satya Praneet Challapilla} % Name Here
\def\phone{+91 7665750037}
\def\city{Hyderabad, Telangana}
\def\email{satyapraneet63@gmail.com}

\def\LinkedIn{satya-praneet-challapilla} % linkedin.com/in/______
\def\github{satyapraneet63} % github username
\def\role{Electronics Engineer | Maker | DevOps} % JOB TITLE
\input{_header}
\begin{document}
